...
public class ForecastAdapter extends RecyclerView.Adapter<ForecastAdapter.ForecastAdapterViewHolder> {
    ...
    public void onBindViewHolder(ForecastAdapterViewHolder forecastAdapterViewHolder, int position) {
        ...
        int weatherId = mCursor.getInt(ForecastFragment.COL_CONDITION_ID);
        int defaultImage = Utility.getIconResourceForWeatherCondition(getItemViewType(mCursor.getPosition()),weatherId);
        ...
        forecastAdapterViewHolder.mDateView.setText(Utility.getFriendlyDayString(mContext, dateInMillis, true));
