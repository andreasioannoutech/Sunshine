package com.kikkos.sunshine.sync;
...
import com.kikkos.sunshine.MainActivity;
import com.kikkos.sunshine.R;
import com.kikkos.sunshine.Utility;
import com.kikkos.sunshine.data.WeatherContract;
import com.kikkos.sunshine.muzei.WeatherMuzeiSource;
...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    public static final String ACTION_DATA_UPDATED =
            "com.kikkos.sunshine.ACTION_DATA_UPDATED";
    ...
    public void onPerformSync(Account account, Bundle extras, String authority, ContentProviderClient provider, SyncResult syncResult) {
        ...
        String units = "metric";
        int numDays = 7;
        String api_id = getContext().getString(R.string.api_key_text);
    ...
    private void getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            if ( cVVector.size() > 0 ) {
                ...
                String yesterdayDate = Long.toString(cal.getTimeInMillis());
                String whereClause = WeatherContract.WeatherEntry.COLUMN_DATE + " <= ?";
                String[] whereArgs = new String[]{yesterdayDate};

                getContext().getContentResolver().delete(WeatherContract.WeatherEntry.CONTENT_URI, whereClause, whereArgs);
            }
        ...
        if (displayNotifications){
            ...
            if (System.currentTimeMillis() - lastSync >= DAY_IN_MILLIS) {
                ...
                if (cursor.moveToFirst()) {
                    ...
                    int iconId = Utility.getIconResourceForWeatherCondition(1, weatherId);
                    String title = context.getString(R.string.app_name);
                    int artResourceId = Utility.getIconResourceForWeatherCondition(0, weatherId);
    ...
    public static void setLocationStatus(Context c, @LocationStatus int locationStatus){
        // storing the location status in the shared preference file.
